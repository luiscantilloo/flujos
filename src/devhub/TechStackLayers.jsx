...
export const TECH_STACK_LAYERS = [
  {
    ...
    items: [
      ...
      },
      {
        name: 'Zustand',
        version: '—',
        role: 'Auth store (persist) + contexto tenant/bodega',
        icon: SiZod,
    ...
    items: [
      {
        name: 'NestJS',
        version: '11',
        role: '✅ auth, configuracion, purchases, inventory, operations, processing, sales, transport, integration, mateo-widget',
        icon: SiNestjs,
        color: 'text-rose-400',
      },
      {
      ...
      {
        name: 'Mateo SSO + Widget',
        version: '—',
        role: '✅ mateo-handoff / mateo-exchange / widget-token · /mateo/conversaciones',
        icon: SiAxios,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: 'PostgreSQL',
        version: '15+',
        role: '41 tablas; RLS híbrido (lectura web / escritura API)',
        icon: SiPostgresql,
        color: 'text-sky-300',
      },
      {
        name: 'Migraciones',
        version: '001–052',
        role: 'polaria-wms-db — RLS + widget Mateo (051/052)',
        icon: SiSupabase,
      ...
      },
      {
        name: 'Integraciones',
        version: '—',
        role: 'Mateo ✅ · Cloudinary ✅ · n8n ✅ · Fridem 🔵',
        icon: SiSupabase,
        color: 'text-teal-300',
      },
    ],
