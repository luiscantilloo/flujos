...
/** 6.1 Onboarding: TI primero, luego administrador de cuenta */
const sub_doc_config_inicial = {
  id: 'sub_doc_config_inicial',
  title: '6.1 — Onboarding (TI → admin cuenta)',
  tabShort: '6.1 Config',
  nodes: [
    {
      id: 'ci_hdr',
      type: 'header',
      data: { label: 'Todo empieza por el equipo TI' },
    },
    {
      id: 'ci_ti_hdr',
      type: 'header',
      data: { label: 'FASE A — Equipo TI (configurador con credenciales)' },
    },
    {
      id: 'ci_ti_login',
      type: 'process',
      data: { label: '0. TI inicia sesión (Auth, panel plataforma)', drillDownTo: 'sub_doc_auth' },
    },
    {
      id: 'ci_emp',
      type: 'process',
      data: { label: '1. Crear empresa (codigoEmpresa)' },
    },
    {
      id: 'ci_admin',
      type: 'process',
      data: {
        label: '2. Crear administrador de cuenta (pertenece a la empresa)',
    ...
    },
    {
      id: 'ci_cta',
      type: 'process',
      data: { label: '3. Crear tenant (codeCuenta) bajo la empresa' },
    },
    {
      id: 'ci_bod',
      type: 'process',
    ...
    },
    {
      id: 'ci_adm_hdr',
      type: 'header',
      data: { label: 'FASE B — Administrador de cuenta' },
    },
    {
      id: 'ci_oper',
      type: 'process',
      data: { label: '5. Operador de cuenta + usuarios' },
    },
    {
      id: 'ci_cat',
      type: 'process',
      data: { label: '6. Catálogo: productos y clientes' },
    },
    {
      id: 'ci_prov',
      type: 'process',
      data: { label: '7. Proveedores y compradores' },
    },
    {
      id: 'ci_flota',
      type: 'process',
      data: { label: '8. Camiones y plantas destino' },
    },
    {
      id: 'ci_equipo',
      type: 'process',
      data: { label: '9. Equipo de bodega (asignacion_bodega)' },
    },
    {
      id: 'ci_check',
      type: 'decision',
      data: { label: '¿Listo para operar (OC / recepción)?' },
    },
    {
      id: 'ci_ok',
      type: 'success',
      data: { label: 'Tenant operativo — operación diaria' },
    },
  ],
  edges: [
    e('ci_e0', 'ci_hdr', 'ci_ti_hdr'),
    e('ci_e0b', 'ci_ti_hdr', 'ci_ti_login'),
    e('ci_e1', 'ci_ti_login', 'ci_emp'),
    ...
    e('ci_e9', 'ci_cat', 'ci_prov'),
    e('ci_e10', 'ci_prov', 'ci_flota'),
    e('ci_e11', 'ci_flota', 'ci_equipo'),
    e('ci_e12', 'ci_equipo', 'ci_check'),
    e('ci_e13s', 'ci_check', 'ci_ok', { sourceHandle: 'yes', label: 'S' }),
    e('ci_e13n', 'ci_check', 'ci_oper', { sourceHandle: 'no', label: 'N', ...L }),
  ],
}
...
const sub_doc_auth = {
  ...
  nodes: [
    ...
    { id: 'au_tipo', type: 'decision', data: { label: '¿Login configurador TI?' } },
    {
      id: 'au_login_ti',
      type: 'process',
  ...
  edges: [
    ...
    e('au_8a', 'au_sub', 'au_dash'),
    e('au_8b', 'au_fri', 'au_dash'),
  ],
}
