...
export const userManualItems = [
  ...
  },
  {
    ...
    roleId: 'configurador',
    keywords: ['configurador', 'plataforma', 'empresa', 'onboarding', 'ti', 'impresora', 'bodega default'],
  },
  {
    id: 'rol-administrador-cuenta',
    category: 'roles',
    title: 'Administrador de cuenta',
    summary: 'Armar el equipo, catálogo, lista de precio, equivalencias, proveedores, clientes y aprobar compras.',
    filePath: '/docs/manual-usuario/roles/administrador-cuenta.md',
    roleId: 'administrador_cuenta',
    keywords: ['admin', 'cuenta', 'catálogo', 'proveedor', 'cliente', 'usuarios', 'equivalencia', 'lista de precio', 'comprador', 'editar', 'teléfono', 'contraseña'],
  },
  {
    id: 'rol-operador-cuenta',
    category: 'roles',
    title: 'Operador de cuenta',
    summary: 'Pedir compras, emitir OC, armar ventas (IA, editar, QR de surtido).',
    filePath: '/docs/manual-usuario/roles/operador-cuenta.md',
    roleId: 'operador_cuenta',
    keywords: ['operador', 'compras', 'ventas', 'solicitud', 'proveedor', 'IA', 'QR', 'captura'],
  },
  {
    ...
    keywords: ['admin bodega', 'estado bodega', 'reportes', 'mapa', 'desde', 'hasta', 'rastrear'],
  },
  {
    id: 'rol-jefe-bodega',
    category: 'roles',
  ...
  },
  {
    ...
    summary: 'Crear la orden (a mano o con IA), emitirla, fotografiar la hoja (QR) y sacar al muelle.',
    filePath: '/docs/manual-usuario/procesos/ventas-despacho.md',
    keywords: ['ov', 'orden venta', 'despacho', 'picking', 'precio', 'QR', 'captura', 'IA', 'editar'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['faq', 'error', 'login', 'no puedo', 'ayuda', 'sesión', 'equivalencia', 'QR', 'Safari', 'lista de precio'],
  },
  {
    id: 'soporte-glosario',
    category: 'soporte',
    ...
    keywords: ['glosario', 'sol', 'oc', 'ov', 'ot', 'palabras', 'equivalencia', 'lista de precio', 'captura', 'QR'],
  },
]
