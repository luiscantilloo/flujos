...
export const WEB_TREE = [
  ...
  { id: 'pw-next', name: 'next.config.ts' },
  {
    ...
    children: [
      ...
      { id: 'pw-doc-mateo-widget', name: 'MATEO-WIDGET.md', hint: '✅ Widget-react embebido' },
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  ...
                  { id: 'pw-mapa', name: 'mapa/page.tsx', hint: '✅ mapa inventario + locking' },
                  { id: 'pw-proc', name: 'procesamiento/page.tsx', hint: '✅ solicitudes y cola' },
                  { id: 'pw-ventas', name: 'ventas/page.tsx', hint: '✅ órdenes de venta' },
                  { id: 'pw-trans', name: 'transporte/page.tsx', hint: '✅ entregas y evidencias' },
                  { id: 'pw-rep', name: 'reporteria/page.tsx', hint: '✅ reportes inventario/mercancía' },
                ],
              },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            id: 'pw-comp-mateo',
            name: 'mateo/',
            hint: '✅ MateoWidgetHost + token widget',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'pw-mod-audit', name: 'audit/', hint: '✅ audit.service.ts' },
          {
            id: 'pw-mod-inv',
            name: 'inventory/',
            hint: '✅ mapa + Realtime + lock/unlock',
            children: [
          ...
          { id: 'pw-mod-wh', name: 'warehouses/', hint: '✅ estado bodega + reportes' },
        ],
      },
      {
        id: 'pw-providers',
...
export const API_TREE = [
  ...
  { id: 'pa-nest-cli', name: 'nest-cli.json' },
  {
    ...
    name: 'docs/',
    children: [
      { id: 'pa-doc-modelo', name: 'MODELO-OPERATIVO.md', hint: '43 modelos Prisma, scope C / C+B' },
  ...
  { id: 'pa-prisma-cfg', name: 'prisma.config.ts' },
  {
    id: 'pa-prisma-dir',
    name: 'prisma/',
    children: [{ id: 'pa-prisma', name: 'schema.prisma', hint: '43 modelos WMS' }],
  },
  {
    id: 'pa-src',
    name: 'src/',
      ...
      },
      {
        ...
        children: [
          { id: 'pa-gen-client', name: 'client.ts' },
          {
            id: 'pa-gen-models',
            name: 'models/',
            hint: '43 modelos (Empresa, Bodega, SolicitudCompra, WarehouseState, WidgetConversacion…)',
          },
        ],
      },
      {
        ...
        children: [
          ...
          { id: 'pa-inv', name: 'inventory/', hint: '✅ warehouse_state + movimientos' },
          { id: 'pa-ops', name: 'operations/', hint: '✅ OT, tareas, alertas, llamadas, presencia' },
          { id: 'pa-notif', name: 'notifications/', hint: '🟡 placeholder' },
          { id: 'pa-proc', name: 'processing/', hint: '✅ flujo procesamiento' },
          { id: 'pa-purchases', name: 'purchases/', hint: '✅ /compras/solicitudes + /compras/ordenes' },
          { id: 'pa-sales', name: 'sales/', hint: '✅ órdenes de venta' },
          { id: 'pa-settings', name: 'settings/', hint: '🟡 placeholder' },
          { id: 'pa-transport', name: 'transport/', hint: '✅ paquetes despacho + entregas' },
          { id: 'pa-mateo-widget', name: 'mateo-widget/', hint: '✅ /mateo/conversaciones' },
