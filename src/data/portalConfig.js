...
export const portalMainSections = [
  ...
  },
  {
    ...
    description:
      'Paso a paso para quien usa Polaria WMS: cada rol, compras, ventas, mapa, transporte y qué hacer si algo no sale.',
    icon: 'UserGroup',
    accent: 'amber',
    enabled: true,
    featured: true,
  ...
  },
  {
    ...
    title: 'Mateo Support',
    description:
      'Widget embebido, JWT n8n vs historial WMS, schema mateo_support y host en web.',
    icon: 'ChatBubbleLeftRight',
    accent: 'sky',
    enabled: true,
    keywords: ['mateo', 'widget', 'chat', 'soporte', 'n8n', 'jwt'],
    action: { type: 'reference', topic: 'mateo' },
  },
  {
    id: 'env-vars',
    category: 'reference',
  ...
  },
  {
    ...
    description: 'Estado vivo: Swagger, mapa, emp_*, Mateo, Prisma precio y huecos reales.',
    icon: 'ClipboardCheck',
    accent: 'violet',
    enabled: true,
  ...
  },
  {
    ...
    description: 'Clonar 4 repos, puertos 3000/3001/5173, .env y primer ticket seguro.',
    icon: 'RocketLaunch',
    accent: 'emerald',
    enabled: true,
  ...
  },
  {
    ...
    category: 'devtools',
    title: 'Runbooks',
    description: 'Deploy Vercel/Render, bodegas Nest, warehouse_state y rotación de secretos.',
    icon: 'Wrench',
    accent: 'amber',
    enabled: true,
  ...
  },
  {
    ...
    category: 'devtools',
    title: 'Testing',
    description: 'Jest e2e API, Vitest web/widget, RLS SQL y Playwright del runner (no producto).',
    icon: 'Beaker',
    accent: 'emerald',
    enabled: true,
