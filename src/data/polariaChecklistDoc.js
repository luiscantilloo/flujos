...
const CHECKLIST_ROWS = [
  ...
  ['CHANGELOG.md en repos de producto', 'Media', 'Completo'],
...
export function formatPolariaChecklistMarkdown() {
  const lines = [
    ...
    '',
    'Checklist viva de **Polaria WMS** (sep 2026). Completo = existe y está alineado al código actual. Parcial = hay algo, pero falta madurar. Pendiente = no hay entregable usable.',
    '',
