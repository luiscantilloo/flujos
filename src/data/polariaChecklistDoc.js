...
const CHECKLIST_ROWS = [
  ...
  ['Migraciones Postgres 001–067 documentadas', 'Alta', 'Completo'],
  ['Storybook o catálogo de componentes UI', 'Baja', 'Pendiente'],
  ['Compliance y normativas aplicables', 'Baja', 'Pendiente'],
  ['Modelo Prisma de `precio_producto` y `comprador_producto_alias` (hoy solo Postgres + JS)', 'Alta', 'Pendiente'],
