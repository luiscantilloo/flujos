...
| Campo | Valor |
|---|---|
| Formulario | Vincular bodega externa |
...
| Listado (bodega externa) | Selección UUID (lista de botones) | Sí | Bodegas externas disponibles no vinculadas a la cuenta | Ninguna seleccionada | Sí para el vínculo cuenta-bodega | Cuenta y empresa | Solo aparecen bodegas de `listBodegasExternasDisponiblesAdmin` | Selecciona una bodega del listado. / No se pudieron cargar las bodegas disponibles. / No se pudo vincular la bodega. | Front, BD |

Vacío de opciones: `No hay bodegas externas disponibles para vincular.`
...
| Listado (bodega externa) | 1…n según el orden del listado | Sí mientras carga opciones o se envía | — |

### Notas y justificaciones

Misma interacción que vincular bodega interna, sobre el catálogo de bodegas externas. No hay input de texto.
